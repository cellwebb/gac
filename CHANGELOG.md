...
- **50/72 Rule Support** - New `--50-72` flag and `GAC_USE_50_72_RULE` config option to enforce the classic commit message format (subject ≤50 chars, body lines ≤72 chars) for optimal readability in git log and GitHub UI
