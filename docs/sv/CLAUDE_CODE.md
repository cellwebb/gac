...
Din webbläsare öppnas automatiskt för ny OAuth-autentisering. Alternativt kan du köra `gac model`, välja "Claude Code" och välja "Autentisera igen (få ny token)".
