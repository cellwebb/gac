...
- [ ] **2. पैकेज में प्रोवाइडर रजिस्टर करें** (`src/gac/providers/__init__.py`)
  ...
  - `PROVIDER_REGISTRY` शब्दकोश में जोड़ें: `"provider-name": call_<provider>_api`
  - `__all__` सूची में जोड़ें: `"call_<provider>_api"`

- [ ] **3. उदाहरण कॉन्फिगरेशन अपडेट करें** (`.gac.env.example`)
...
- [ ] **4. दस्तावेज़ीकरण अपडेट करें** (`README.md` और `docs/` में सभी `README.md` अनुवाद)

  - सभी README अनुवादों में "समर्थित प्रोवाइडर्स" अनुभाग में प्रोवाइडर नाम जोड़ें
  - बुलेट पॉइंट्स के भीतर सूची को वर्णानुक्रम में क्रमबद्ध रखें
...
- [ ] **5. इंटरैक्टिव सेटअप में जोड़ें** (`src/gac/init_cli.py`)
  ...
  - **महत्वपूर्ण**: यदि आपका प्रोवाइडर गैर-मानक API कुंजी नाम का उपयोग करता है (स्वचालित रूप से उत्पन्न `{PROVIDER_UPPERCASE}_API_KEY` नहीं), तो विशेष हैंडलिंग जोड़ें:
    ...
    उदाहरण: `kimi-for-coding` `KIMI_CODING_API_KEY` का उपयोग करता है, `moonshot-ai` `MOONSHOT_API_KEY` का उपयोग करता है

- [ ] **6. व्यापक परीक्षण बनाएं** (`tests/providers/test_<provider>.py`)
...
- [ ] **7. वर्जन बंप करें** (`src/gac/__version__.py`)
...
6. **प्रोवाइडर रजिस्ट्रेशन**: केवल `src/gac/providers/__init__.py` और `src/gac/init_cli.py` में बदलाव करें – `ai.py` और `ai_utils.py` स्वतः रजिस्ट्रि से पढ़ते हैं
7. **प्रोवाइडर नाम प्रारूप**: बहु-शब्द नामों के लिए लोअरकेस के साथ हाइफन का उपयोग करें (जैसे, "lm-studio")
8. **वर्जन बंप**: प्रोवाइडर जोड़ने के लिए एक **माइनर** वर्जन बंप की आवश्यकता होती है (नई सुविधा)
