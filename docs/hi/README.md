...
- **प्रति-प्रोजेक्ट आँकड़े**: `gac stats project` के साथ वर्तमान रेपो के लिए आँकड़े देखें
- **उच्च स्कोर उत्सव**: 🏆 नए दैनिक, साप्ताहिक, या स्ट्रीक रिकॉर्ड स्थापित करने पर ट्रॉफी; 🥈 उन्हें बराबरी करने पर
- **ऑप्ट-आउट सहभागी**: ट्रैकिंग अक्षम करने के लिए `GAC_DISABLE_STATS=1` सेट करें — कोई डेटा लिखा नहीं जाता
- **गोपनीयता प्राथमिकता**: केवल गिनती, तिथियां, और प्रोजेक्ट नाम (git remote/निर्देशिका से प्राप्त) संग्रहीत करता है — कोई कमिट मैसेज, कोड, या व्यक्तिगत डेटा नहीं
...
# केवल वर्तमान प्रोजेक्ट के लिए आँकड़े
gac stats project
