...
- `GAC_DISABLE_STATS=true` - उपयोग सांख्यिकी ट्रैकिंग अक्षम करें (कोई स्टैट्स फाइल पढ़ने या लिखने का नहीं; मौजूदा डेटा संरक्षित रहता है)
...
- `gac stats show` — अपनी gac उपयोग सांख्यिकी देखें (कुल, स्ट्रीक, दैनिक और साप्ताहिक गतिविधि, शीर्ष प्रोजेक्ट)
- `gac stats project` — केवल वर्तमान git प्रोजेक्ट के लिए आँकड़े देखें
...
gac हल्की उपयोग सांख्यिकी को ट्रैक करता है ताकि आप अपनी कमिट गतिविधि, स्ट्रीक, और सबसे सक्रिय प्रोजेक्ट देख सकें। आँकड़े स्थानीय रूप से `~/.gac_stats.json` में संग्रहीत होते हैं और कभी कहीं नहीं भेजे जाते।

**क्या ट्रैक किया जाता है:** कुल gac रन, कुल कमिट्स, पहली/अंतिम उपयोग तिथियां, दैनिक और साप्ताहिक गणना, वर्तमान और सबसे लंबी स्ट्रीक, और प्रति-प्रोजेक्ट गतिविधि गणना।

**क्या ट्रैक नहीं किया जाता:** कमिट मैसेज, कोड सामग्री, फाइल पाथ, व्यक्तिगत जानकारी, या गणना और प्रोजेक्ट नामों के अलावा कुछ भी।
...
| `gac stats show`    | पूर्ण सांख्यिकी प्रदर्शित करें: कुल, स्ट्रीक, दैनिक और साप्ताहिक गतिविधि, शीर्ष प्रोजेक्ट |
| `gac stats project` | केवल वर्तमान git प्रोजेक्ट के लिए सांख्यिकी दिखाएं                                        |
| `gac stats reset`   | सभी सांख्यिकी को शून्य पर रीसेट करें (पुष्टि के लिए प्रॉम्प्ट करता है)                    |
...
# केवल वर्तमान प्रोजेक्ट के लिए सांख्यिकी
gac stats project
...
- **गतिविधि सारांश** — आज और इस सप्ताह के gac/कमिट बनाम आपके पीक दिन और पीक सप्ताह
- **शीर्ष प्रोजेक्ट** — gac + कमिट गणना के अनुसार आपके 5 सबसे सक्रिय रेपो
- **उच्च स्कोर उत्सव** — 🏆 नए दैनिक, साप्ताहिक, या स्ट्रीक रिकॉर्ड स्थापित करने पर ट्रॉफी; 🥈 उन्हें बराबरी करने पर
- **प्रोत्साहन संदेश** — आपकी गतिविधि के आधार पर संदर्भात्मक प्रोत्साहन

### सांख्यिकी अक्षम करना

`GAC_DISABLE_STATS` पर्यावरण चर को किसी भी मान पर सेट करें:
...
अक्षम होने पर, gac सभी सांख्यिकी रिकॉर्डिंग को छोड़ देता है — कोई फाइल पढ़ने या लिखने का नहीं होता। मौजूदा डेटा संरक्षित रहता है लेकिन तब तक अपडेट नहीं होगा जब तक आप इस चर को हटा न दें।
