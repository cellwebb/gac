...
- `GAC_NO_TIKTOKEN=true` - `tiktoken` डाउनलोड चरण को बायपास करके और अंतर्निहित अनुमानित टोकन अनुमानक का उपयोग करके पूरी तरह से ऑफलाइन रहें
...
- `gac auth` — Claude Code OAuth टोकन को प्रमाणित या पुनः प्रमाणित करें (टोकन एक्सपायर होने पर उपयोगी)
