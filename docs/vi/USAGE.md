...
- **Đang sử dụng ChatGPT OAuth?** Xem [hướng dẫn thiết lập ChatGPT OAuth](CHATGPT_OAUTH.md) để biết hướng dẫn xác thực dựa trên trình duyệt.
...
- `gac auth chatgpt status` — Kiểm tra trạng thái xác thực ChatGPT
