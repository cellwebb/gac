...
class TestGacCommit:
    ...
    @patch("gac.ai.generate_commit_message", return_value="feat: add feature")
    ...
    @patch("gac.ai.generate_commit_message", return_value="fix: patch bug")
    @patch("gac.prompt_builder.PromptBuilder")
    @patch("gac.git_state_validator.GitStateValidator")
    @patch("gac.git.get_staged_files", return_value=["src/app.py"])
    @patch("gac.git.run_git_command")
    ...
    @patch("gac.ai.generate_commit_message", return_value="feat: add login")
    @patch("gac.prompt_builder.PromptBuilder")
    @patch("gac.git_state_validator.GitStateValidator")
    ...
    @patch("gac.ai.generate_commit_message", return_value="feat: add push")
    @patch("gac.prompt_builder.PromptBuilder")
    @patch("gac.git_state_validator.GitStateValidator")
    ...
    @patch("gac.ai.generate_commit_message", return_value="")
    @patch("gac.prompt_builder.PromptBuilder")
    @patch("gac.git_state_validator.GitStateValidator")
    @patch("gac.git.get_staged_files", return_value=["a.py"])
    @patch("gac.git.run_git_command")
    ...
    @patch("gac.ai.generate_commit_message", return_value="feat: secret stuff")
    @patch("gac.prompt_builder.PromptBuilder")
    @patch("gac.git_state_validator.GitStateValidator")
    @patch("gac.git.get_staged_files", return_value=["src/app.py"])
    @patch("gac.git.run_git_command")
    ...
    @patch("gac.ai.generate_commit_message", return_value="feat: with model override")
    @patch("gac.prompt_builder.PromptBuilder")
    @patch("gac.git_state_validator.GitStateValidator")
    @patch("gac.git.get_staged_files", return_value=["a.py"])
    @patch("gac.git.run_git_command")
